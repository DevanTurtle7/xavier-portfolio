...
import {Button, Input, Col, Row, FormGroup, FormFeedback} from 'reactstrap';
...
class Admin extends Component {
  ...
  validData = () => {
    return (
      this.validField(this.state.email) && this.validField(this.state.password)
    );
  };
    ...
    if (this.state.user == null) {
      ...
      return (
        <Fragment>
          ...
          <h1 className='mx-4'>Admin</h1>
          <Button onClick={this.signOut} className='mx-4 mt-2 mb-4'>
            Sign Out
          </Button>
